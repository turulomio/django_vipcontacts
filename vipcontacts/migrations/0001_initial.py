# Generated by Django 3.1.7 on 2021-04-01 06:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='personrelation', to='vipcontacts.person')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dt_update', models.DateTimeField(default=django.utils.timezone.now)),
                ('type', models.IntegerField(choices=[(0, 'Contact value changed'), (1, 'Contact value added'), (2, 'Personal')])),
